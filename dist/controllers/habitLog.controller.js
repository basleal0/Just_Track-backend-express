...
export const updateHabitLog = async (req, res) => {
    try {
        ...
        const utcMidnight = new Date(Date.UTC(parsedDate.getUTCFullYear(), parsedDate.getUTCMonth(), parsedDate.getUTCDate()));
...
export const getHabitLogs = async (req, res) => {
    try {
        ...
        // Date range filter (from - to)
            ...
            const fromUtc = new Date(Date.UTC(parsedFrom.getUTCFullYear(), parsedFrom.getUTCMonth(), parsedFrom.getUTCDate()));
            const toUtc = new Date(Date.UTC(parsedTo.getUTCFullYear(), parsedTo.getUTCMonth(), parsedTo.getUTCDate()));
            whereCondition.date = {
                gte: fromUtc,
                lte: toUtc,
            };
...
//# sourceMappingURL=habitLog.controller.js.map